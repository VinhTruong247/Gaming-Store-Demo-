            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <c:if test="${sessionScope.user != null}">
                        ...
                        <input required="" type="text" disabled="" id="fname" name="fullName" value="${sessionScope.user.fullName}">
                        <label for="email"><i class="fa fa-envelope"></i> Email</label>
                        <input required="" type="text" disabled="" id="email" name="email" value="${sessionScope.user.email}">
                        <label for="address"><i class="fa fa-home"></i> Address</label>
                        <input required="" type="text" disabled="" id="adr" name="address" value="${sessionScope.user.address}">
                    </c:if>
                    <c:if test="${sessionScope.user == null}">
                        <label for="fullName"><i class="fa fa-user"></i> Full Name</label>
                        <input required="" type="text" id="fname" name="fullName" placeholder="Your Name">
                        <label for="email"><i class="fa fa-envelope"></i> Email</label>
                        <input required="" type="text" id="email" name="email" placeholder="abc@example.com">
                        <label for="address"><i class="fa fa-home"></i> Address</label>
