    ...
    <div class="container">
        <div class="row">
            ...
            <div class="pagination">
                <ul>
                    <li><a href="<c:url value="/product/page_2.page"/>">&laquo;</a></li>
                    <li><a href="<c:url value="/product/page_1.page"/>">1</a></li>
                    <li><a href="<c:url value="/product/page_2.page"/>">2</a></li>
                    <li><a href="<c:url value="/product/page_3.page"/>" class="active">3</a></li>
                    ...
                    <li><a href="<c:url value="/product/page_4.page"/>">&raquo;</a></li>
                </ul>
            </div>
