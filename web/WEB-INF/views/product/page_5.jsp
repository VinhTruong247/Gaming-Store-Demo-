<%-- 
    Document   : page_1
    Created on : Mar 13, 2023, 10:54:27 AM
    Author     : Admin
--%>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="pagination">
                <ul>
                    <li><a href="<c:url value="/product/page_4.page"/>">&laquo;</a></li>
                    ...
                    <li><a href="<c:url value="/product/page_5.page"/>" class="active">5</a></li>
                    <li><a href="<c:url value="/product/page_6.page"/>">6</a></li>
                    <li><a href="<c:url value="/product/page_7.page"/>">7</a></li>
                    <li><a href="<c:url value="/product/page_6.page"/>">&raquo;</a></li>
                </ul>
            </div>
