        ...
        <c:if test="${sessionScope.user!=null && sessionScope.user.role=='ADMIN'}">
            <c:if test="${isTrue==true}">
                <div class="row">
                    ...
                    <form action="<c:url value="/manager/promote_handler.page" />">
                        <p>Do you want to promote this user to ADMIN rank?</p>
                        <input type="hidden" name="userId" value="${selectedUser.userId}">
                        <button type="submit" class="btn btn-outline-success" name="op" value="promote"><i class="bi bi-check-lg"></i> Promote</button>
